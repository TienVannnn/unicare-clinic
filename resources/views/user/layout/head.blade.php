...
<title>{{ ($title ?? 'Trang chủ') . ' - Công ty cổ phần y tế UNI CARE Nha Trang' }}</title>
<link rel="icon" href="/user/assets/img/favicon2.png" />
<link
...
<link rel="stylesheet" href="/user/assets/css/normalize.css" />
